...
2. 사용자 정보 설정
   ...
   ```
   git config --list
   git config --global user.name "look-93"
   git config --global user.email "qhfk0961@gmail.com"
   ```
...
4. 레포지토리 연결
   - 새 컴퓨터에서 원하는 폴더로 이동 후: 
     ...
     ```
     cd D:\kimbora
     git clone https://github.com/look-93/2026-AI-FULLSTACK.git
     ```
...
--- 
## Part002 
- TODO2: 마크다운 문법 (Extension: Markdown Preview Enhanced)
...
<img src="me.png" alt="어여쁜학생" style="width:80px" />
