...
jwt/oauth2 사용자 통합 클래스
 ...
 - SecurityContext 에서 principal 타입으로 일돤되게 유지
*/

@Getter
public class CustomOAuth2User implements OAuth2User, UserDetails { //OAuth2User: 소셜 사용자정보, UserDetails : 시큐리티
 
    private static final long serialVersionUID = 1L;
	
    private final Long id;     // jwt subject 유저        
    private final String provider;  // goole, kakao, naver + local
    ...
    @Override
    public String getPassword() { return "N/A"; }     // password 설정x N/A: not a number
