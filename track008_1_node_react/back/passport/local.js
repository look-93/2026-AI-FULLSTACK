...
const { findUserByEmail } = require('../models/users');   // db사용자 조회 함수

module.exports = () => {
  passport.use(new LocalStrategy(
           {  usernameField: 'email',    //로그인시 사용할 필드명 req.body.email 이름과 동일해야함
              passwordField: 'password', //로그인시 사용할 필드명 req.body.password 이름과 동일해야함
           }, //설정
           async (email, password, done) => {
                try{
                    ...
                    if(match){ return done(null , user); } // -> index.js done(null, user);
