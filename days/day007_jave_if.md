...
2. css
3. 배경을 노란색으로 설정하는 속성은?

- background-color: yellow

4. 글자색상을 초록색으로 지정하는 속성은?

- color: green

5. 글자 크기를 30px로 지정하는 속성은?

- font-size:30px

6. 글자를 오른쪽으로 정렬하는 속성은?
...
8. 글꼴을 'Times New Roman'으로 지정하는 속성은?

- font-family: 'Times New Roman'

9. 글자를 굵은표시를 기본으로 표시하는 속성은?

- font-weight:bold

10. 요소의 세로 길이를 400px로 지정하는 속성은?

- height: 400px

11. 요소의 바깥쪽 여백을 20px로 지정하는 속성은?

- padding: 20px

12. 요소의 안쪽 여백을 5px로 지정하는 속성은?

- margin: 5px

13. 요소에 2px 점선 테두리를 추가하는 속성은?

- border: 2px dotted red;

14. 모서리를 둥글게 50%로 만드는 속성은?

- border-radius:50%

15. 그림자 효과를 빨간색으로 추가하는 속성은?

- box-shadow: 0 0 10px rgba(200,0,0,0.1)

16. 빠르게 움직이는 장면전환효과를 주는 속성은?
