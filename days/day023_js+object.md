...
class A11 {
    ...
    //(3) void show() 인스턴스메서드 - heap - new 생성자 - this 각각
    void show() { 
        this.a = 11; 
...
Q2. 클래스 A11에서 오류나는 곳을 수정하고 그 이유를 적으시오.
 static void classMethod() { this.a = 12; } // static은 인스턴스(this.a) 사용불가 - 로딩시점 다름
...
// 오버로딩 메서드이름이 같고 파라미터 타입과 갯수가 같아야함
...
Q6. 다형성이란?  한가지 타입으로 여러 형태를 사용할 수 있는 성질
