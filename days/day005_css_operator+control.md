...
- 3. java  
     패키지명 : com.company.java003*ex
     클래스명 : Day005
     출력내용 : Scanner이용해서 나누기 프로그램만들기
     숫자입력1> *입력받기 10 ( ☆자료형을 int )
...
> 정리문제 (2) 15. 가로 사이즈 지정가능한것은 block / inline 16. a태그에 margin-top 줄수 o / x 17. css 적용방법 3가지 ( 인라인 / 내부 / 외부 ) 18. css 적용 내부적용방법은 ( head ) 태그안에 ( style ) 태그 적용해서 사용
