...
> 정리문제 (2) 15. 가로 사이즈 지정가능한것은 block 16. a태그에 margin-top 줄수 x 17. css 적용방법 3가지 ( 인라인 / 내부 / 외부 ) 18. css 적용 내부적용방법은 ( head ) 태그안에 ( style ) 태그 적용해서 사용
...
1. 웹페이지의 배경을 하늘색으로 바꾸고 싶다. 어떤 속성을 써야 할까? ****\_\_\_\_****
2. 제목 글자를 초록색으로 바꾸려면? ****\_\_\_\_****
3. 본문 글자의 크기를 18px로 지정하려면? ****\_\_\_\_****
4. 메뉴 글자를 오른쪽으로 정렬하려면? ****\_\_\_\_****
5. 링크에 밑줄을 없애려면? ****\_\_\_\_****
6. 글꼴을 'Times New Roman'으로 바꾸려면? ****\_\_\_\_****
7. 강조하고 싶은 단어를 굵게 표시하려면? ****\_\_\_\_****
8. 이미지를 가로 400px로 줄이고 싶다. 어떤 속성? ****\_\_\_\_****
9. 박스 바깥쪽에 20px 여백을 주려면? ****\_\_\_\_****
10. 버튼 안쪽에 8px 여백을 주려면? ****\_\_\_\_****
11. 카드 요소에 2px 점선 테두리를 주려면? ****\_\_\_\_****
12. 프로필 사진 모서리를 둥글게 50%로 만들려면? ****\_\_\_\_****
13. 박스에 살짝 번지는 그림자 효과를 주려면? ****\_\_\_\_****
14. 버튼에 마우스를 올렸을 때 부드럽게 색이 바뀌도록 하려면? ****\_\_\_\_****
