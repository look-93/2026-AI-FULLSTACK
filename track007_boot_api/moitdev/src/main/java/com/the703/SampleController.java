...
public class SampleController {
	...
	public String tmptAdmin() {return "tmptAdmin"; } //prefix(/templates) + tmpt + suffix(.html)
	
	@GetMapping("/tmptMain")
	public String tmptMain() {return "tmptMain"; } //prefix(/templates) + tmpt + suffix(.html)

	@GetMapping("/tmptMeetupList")
	public String tmptMeetupList() {return "tmptMeetupList"; } //prefix(/templates) + tmpt + suffix(.html)
	
	@GetMapping("/tmptMypage")
	public String tmptMypage() {return "tmptMypage"; } //prefix(/templates) + tmpt + suffix(.html)
