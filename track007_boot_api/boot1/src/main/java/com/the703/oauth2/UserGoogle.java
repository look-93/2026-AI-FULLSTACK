...
@AllArgsConstructor // 모든 필드를 생성자로부터 받기 - 컴파일 시점에서 자동생성 // 모든 필드를 매개변수로 받는 생성자를 컴파일 시 자동 생성
public class UserGoogle implements UserInfoOAuth2{
	private final Map<String, Object> attributes; //@Autowired - 스프링이 생성자 찾아서 di
