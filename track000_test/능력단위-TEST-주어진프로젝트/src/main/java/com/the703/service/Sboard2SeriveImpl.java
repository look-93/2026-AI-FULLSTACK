...
public class Sboard2SeriveImpl  implements Sboard2Service{
	...
	@Override public int searchCnt(String keyword) { return dao.searchCnt(keyword); }
	...
	@Override public List<Sboard2Dto> searchByKeyword(String keyword, int pageNo) {
	    HashMap<String, Object> para = new HashMap<>();

	    para.put("keyword", keyword);
	    para.put("start", (pageNo-1)*10);
	    para.put("end", 10);
        return dao.searchByKeyword(para);
    }
}
