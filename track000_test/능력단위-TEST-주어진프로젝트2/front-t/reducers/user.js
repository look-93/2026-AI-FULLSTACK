...
const reducer = ( state = initialState , action )=>{ 
    switch(action.type){
        ...
        case SEARCH_USERS_REQUEST:
            return {
                ...state, searchUsersLoading:true, searchUsersError: null
            };
        case SEARCH_USERS_SUCCESS:
            return {
                ...state, searchUsersLoading:false, searchResults: action.data, searchUsersDone: true,
            };

        case SEARCH_USERS_FAILURE:
            return {
                ...state, searchUsersLoading: false, searchUsersDone: false, searchUsersError: action.error?.message || action.error
            };
