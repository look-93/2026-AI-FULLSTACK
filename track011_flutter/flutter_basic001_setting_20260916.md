...
```
내pc -> 속성 -> 고급시스템설정 -> 환경변수 -> path -> C:\flutter\bin -> 맨위로이동 -> 확인

```

```bash
# Flutter 환경 점검 명령어
# android SDL, vs code, C++ 빌드도구 등 사용가능한지 점검(!,x)
# 새창 cmd 에서 실행
flutter doctor
...
```bash
C:\Users\TJ-BU-703-018PC>flutter doctor
...
Downloading packages... (1:11.5s)
Got dependencies.
[1/10] Material Fonts                                            (2.2MB in 0.3s)
[2/10] Gradle Wrapper                                            (0.1MB in 0.0s)
[3/10] Flutter SDK
  ├─ [1/5] sky_engine                                            (1.5MB in 0.2s)
  ├─ [2/5] flutter_gpu                                           (0.1MB in 0.0s)
  ├─ [3/5] flutter_patched_sdk                                   (3.9MB in 0.3s)
  ├─ [4/5] flutter_patched_sdk_product                           (3.9MB in 0.2s)
  └─ [5/5] windows-x64                                          (29.1MB in 2.1s)
[10/10] windows-x64/font-subset                                  (2.1MB in 0.1s)
Doctor summary (to see all details, run flutter doctor -v):
[√] Flutter (Channel stable, 3.47.4, on Microsoft Windows [Version 10.0.19045.6466], locale ko-KR)
[√] Windows Version (10 Pro 64비트, 22H2, 2009)
[X] Android toolchain - develop for Android devices
    X Unable to locate Android SDK.  # 설치x
...
[X] Visual Studio - develop Windows apps # 설치x
    X Visual Studio not installed; this is necessary to develop Windows apps.
      Download at https://visualstudio.microsoft.com/downloads/. # 다운로드경로
...
- https://visualstudio.microsoft.com/downloads/ -> 무료다운로드
