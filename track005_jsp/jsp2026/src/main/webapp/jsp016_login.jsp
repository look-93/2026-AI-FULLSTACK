...
<body>
	<div class="container card  my-5">
      ...
      ■ 3. 로그아웃 버튼클릭시 로그아웃 처리   ( 로그인시에만 보이기)
		...
		<form action="jsp016_result.jsp" method="post"
			...
			<div class="my-3">
				<label for="bpass" class="form-label">Password : </label> <input
					type="password" class="form-control" id="bpass" name="bpass" />
			</div>
			<div class="my-3">
				<label for="check" class="form-label">Remember : </label> <input
					type="checkbox" id="check" name="remember" />
			</div>
			<div class="my-3">
				<button type="submit" title="login 하러가기" class="btn btn-danger"
					id="check" name="remember">로그인</button>
			</div>
		</form>
