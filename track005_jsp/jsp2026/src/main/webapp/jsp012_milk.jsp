            ...
            <div class="card mb-3">
               ...
               <div id="collapseOne" class="collapse show" data-bs-parent="#accordion">
                  <div class="card-body">
                  	...
                  	<!-- form -->
                  	<form action="jsp012_insert.jsp"  method=post onsubmit="return orderCheck()">
						<div class="my-3">
							<label for="oname" class="form-label">주문할 우유이름</label>
							<input type="text"  class="form-control" placeholder="주문할 우유이름을 적어주세요!" id="oname" name="oname" />      
						</div>
						
						<div class="my-3">
							<label for="onum" class="form-label">주문할 우유갯수</label>
							<input type="text" class="form-control" placeholder="우유갯수를 적어주세요!" id="onum" name="onum" />      
						</div>
						
						<div class="my-3" >
							<button type="submit" title="주문하기" class="btn btn-warning" id="orderBtn" name="orderBtn" >
								주문하기
							</button>
						</div>						
					</form>
		 	...
		 	<div class="card mb-3">
			   ...
			   <div id="collapseTwo" class="collapse" data-bs-parent="#accordion">
			     <div class="card-body">
			     	...
			     	<!-- form -->
			     	<form action="jsp012_update.jsp" method="post" onsubmit="return updateCheck()">
			     	
				       <div class="my-3">
							<label for="updateOno" class="form-label">수정할 우유번호</label>
							<input type="text"  class="form-control" placeholder="수정할 우유번호을 적어주세요!" id="updateOno" name="updateOno" />      
						</div>
						
				       <div class="my-3">
							<label for="updateOname" class="form-label">수정할 우유이름</label>
							<input type="text"  class="form-control" placeholder="수정할 우유이름을 적어주세요!" id="updateOname" name="updateOname" />      
						</div>
												
						<div class="my-3">
							<label for="updateOnum" class="form-label">수정할 우유갯수</label>
							<input type="text" class="form-control" placeholder="수정할 우유갯수를 적어주세요!" id="updateOnum" name="updateOnum" />      
						</div>
						
						<div class="my-3" >
							<button type="submit" title="수정하기" class="btn btn-warning" id="updateBtn" name="updateBtn" >
								수정하기
							</button>
						</div>
			    ...
			    <div id="collapseThree" class="collapse" data-bs-parent="#accordion">
			      <div class="card-body">
			        <!-- form  -->
			      	...
			      	<form action="jsp012_delete.jsp" method="post" onsubmit="return deleteCheck()">
						<div class="my-3">
							<label for="deleteOno" class="form-label">삭제할 번호</label>
							<input type="password" class="form-control" placeholder="삭제 번호를 적어주세요!" id="deleteOno" name="deleteOno" />      
						</div>
						
						<div class="my-3" >
							<button type="submit" title="삭제하기" class="btn btn-warning" id="deleteBtn" name="deleteBtn" >
								삭제하기
							</button>
						</div>		
					</form>
