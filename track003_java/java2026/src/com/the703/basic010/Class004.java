...
/*
	Object				 2) Object(){						       } 3) object 호출(객체틀은 이렇게생겼으면좋겠어 name, price)
	   ↑
	Product{name, price} 1) Product(){ super(); name=null, price=0 } 4) 초기화 후 닫힘 name=numm, price=0)
...
class Product extends Object{ // 상속을 받을께, Object (클래스의 기본틀) , Object 생략가능
	...
	public Product(String name, int price) { super(); this.name = name; this.price = price; } //this (각 주소의 속성)
//	@Override
...
public class Class004 {
	public static void main(String[] args) {
		Product p1 = new Product(); //1)new 객체생성 2) 생성자-초기화 3) p1주소갖기 (1번지)
		System.out.println(p1);     // p1(1번지) → 1번지: Product [name=null, price=0]
		
		Product p2 = new Product("아이폰17", 100); //1)new 객체생성 2) 생성자-초기화 3) p2주소갖기 (2번지)
