...
/*상속도
								 Robot {name, work()}
				  			       ↑	
FightingRobot 				  CookingRobot 				CleaningRobot
{name, @work(), vacuum()} {name, @work(), cook()}      {name, @work(), attack()}]
...
/* Robot[] robots = { new CleaningRobot(),    new CookingRobot(),     new FightingRobot() };
   {name, work()}  {name, work(), vacuum()} {name, work(), cook()}   {name, work(), attack()}

*/

//abstract 추상클래스 - 설계틀만 잡음
