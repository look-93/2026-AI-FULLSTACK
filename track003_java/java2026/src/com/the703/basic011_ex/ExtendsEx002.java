...
class MobileNote7 extends MobileNote{
	...
	private String face;  
	void newShow() {
		System.out.print("NOTE7 객체 기능(Overriding)" + "\n" 
						+"iris = " + this.iris + "\n"
						+"face = " + this.face + "\n"
						);
	}	
...
class MobileNote8 extends MobileNote7{ // 상속시
	...
	@Override void newShow() {
		super.newShow(); //오버라이딩 부모클래스의 멤버함수 호출가능
		System.out.print("NOTE8 객체 기능(Overriding) 추가" + "\n" 
						+"face = " + this.getFace() + "\n"
						);		
	}
...
class MobileNote9 extends MobileNote8{
	...
	@Override void newShow() { 
		super.newShow();
		System.out.print("NOTE9 객체 기능(Overriding) 추가" + "\n" 
						+ "battery 예쁘게 사용하기!\n" 
