...
public class Datatype001 {
	...
	public static void main(String[] args) {
	      ...
	      double dp1 = 1.00000000000000;  // 0 14개 → 정확하게 표현
	      double dp2 = 1.000000000000001; // 0 15개 + 1 = 16개 → 정밀도 초과 반올림	   
	      double dp3 = 1.111111111111111; // 0 15개 + 1 = 16개 → 근사값
	      System.out.println(dp1 + "\t" + dp2 + "\t" + dp3); 
	      // 				1.0			  1.000000000000001		1.111111111111111
