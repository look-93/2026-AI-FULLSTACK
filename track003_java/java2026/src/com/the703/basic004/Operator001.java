...
public class Operator001 {
	...
	public static void main(String[] args) {
		...
		System.out.println(a/b); //3 몫 (정수/정수=정수)
		System.out.println(a%b); //1 나머지
		
		//Q1. 나머지 연산자 - 짝수니? 홀수니? (2개) n%2 나머지 : 0,1										
		System.out.println("Q1. " + 0%2 + "\t" + 1%2 + "\t" + 2%2 + "\t" + 3%2 );
		
		//Q2. 3의 배수는? a가 3의 배수니? / b가 3의 배수니? 3의 나머지 0 
		...
		//Q2. b가 3의 배수가 아니라면 false
		System.out.println(b%3 != 0);
		
		//3. 조건 &&(모든조건을 만족) ||(여러조건중에서 하나라도 만족하면 true)
