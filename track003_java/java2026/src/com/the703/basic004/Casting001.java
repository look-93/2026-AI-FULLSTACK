...
public class Casting001 {
	...
	public static void main(String[] args) {
		...
		//lo = fl; //정수형(8byte) - 실수형(4byte) Type mismatch: cannot convert from float to long
		fl = lo; //실수형(4byte) - 정수형(8byte)
		//in = bl; //정수형(4byte) - 논리형(1byte) Type mismatch: cannot convert from boolean to int
