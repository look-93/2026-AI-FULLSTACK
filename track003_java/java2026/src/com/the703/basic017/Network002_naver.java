	...
	public static void main(String[] args) {
		try {
			...
			String apiurl = "https://openapi.naver.com/v1/search/news.json?query="
						  + URLEncoder.encode("etf", "UTF-8"); //## 검색어 etf수정
...
//			Client ID : 0l9jNlWRLdsw3zslWnIL
//			Client Secret : ttsQCf6r1i
			conn.setRequestMethod("GET");
			conn.setRequestProperty("X-Naver-Client-Id", "0l9jNlWRLdsw3zslWnIL");
			conn.setRequestProperty("X-Naver-Client-Secret", "ttsQCf6r1i");
			//4. 응답확인
