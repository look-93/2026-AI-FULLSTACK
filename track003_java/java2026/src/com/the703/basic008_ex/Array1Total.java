...
public class Array1Total {
	...
	public static void main(String[] args) {
	    ...
	    for(int i=0;i<names.length;i++) {
	    	String name = names[i], p = pass[i], j = jang[i];
	    	int kor = kors[i], eng = engs[i], mat = mats[i], aver = avers[i];
	    	
//	    	System.out.println(name + "\t" + kor + "\t" + eng + "\t" +  mat + "\t" + aver + "\t" + p + "\t" +j);
	    	result = result + name + "\t" + kor + "\t" + eng + "\t" +  mat + "\t" + aver + "\t" + p + "\t" + j + "\n";
	    }	    
