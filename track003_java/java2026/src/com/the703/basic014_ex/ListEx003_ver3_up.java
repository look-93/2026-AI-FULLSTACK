...
class IceCreamDTO3{
	...
	public IceCreamDTO3() { super(); }
	public IceCreamDTO3(String name) { super(); this.name = name; }  //##
	public IceCreamDTO3(String name, int price) { super(); this.name = name; this.price = price; }
	...
	@Override public boolean equals(Object obj) {
		...
		IceCreamDTO3 other = (IceCreamDTO3) obj;
...
public class ListEx003_ver3_up { 
	public static void main(String[] args) {
		 ...
		 List<IceCreamDTO3>  list = new ArrayList<>();
		 ...
		 while( choice != 0) { 
			...
			switch(choice) {
            	...
            	case 6 : //6. 정렬
            	    ...
            	    if(sortChoice == 1) {
            	        Collections.sort(list, Comparator.comparing(IceCreamDTO3::getName));
            	        
            	        System.out.println("🍦 이름순으로 정렬 완료!");
            	    } else if(sortChoice == 2) {
            	        Collections.sort(list, Comparator.comparingInt(IceCreamDTO3::getPrice));
